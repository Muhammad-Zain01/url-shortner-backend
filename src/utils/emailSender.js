...
class EmailSender {
    ...
    async PasswordResetEmail(email, user, password) {
        return await this.send(email, "Your New Password", this.PasswordReset(user, password))
    }
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="640"
                    ...
                    <tr>
                        <td style="padding: 48px 32px 20px; text-align: center; background-color: #ffffff;">
                            ...
                            <p
                                style="height: auto; padding: 20px; margin: 28px 0 15px; font-family: Poppins; font-size: 20px; font-weight: bold; line-height: 27px; color: #0966adfd;">
                                ${password}
                            </p>
                        </td>
                    </tr>
